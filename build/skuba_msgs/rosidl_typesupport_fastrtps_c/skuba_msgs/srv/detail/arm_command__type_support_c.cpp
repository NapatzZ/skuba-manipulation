...
#include "skuba_msgs/srv/detail/arm_command__rosidl_typesupport_fastrtps_c.h"
...
using _ArmCommand_Request__ros_msg_type = skuba_msgs__srv__ArmCommand_Request;
...
size_t get_serialized_size_skuba_msgs__srv__ArmCommand_Request(
  const void * untyped_ros_message,
...
static uint32_t _ArmCommand_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_skuba_msgs__srv__ArmCommand_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_skuba_msgs
size_t max_serialized_size_skuba_msgs__srv__ArmCommand_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = skuba_msgs__srv__ArmCommand_Request;
    is_plain =
      (
...
static size_t _ArmCommand_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_skuba_msgs__srv__ArmCommand_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, skuba_msgs, srv, ArmCommand_Request)() {
...
using _ArmCommand_Response__ros_msg_type = skuba_msgs__srv__ArmCommand_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_skuba_msgs
size_t get_serialized_size_skuba_msgs__srv__ArmCommand_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ArmCommand_Response__ros_msg_type * ros_message = static_cast<const _ArmCommand_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_skuba_msgs__srv__ArmCommand_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_skuba_msgs
size_t max_serialized_size_skuba_msgs__srv__ArmCommand_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = skuba_msgs__srv__ArmCommand_Response;
    is_plain =
      (
...
static size_t _ArmCommand_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_skuba_msgs__srv__ArmCommand_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, skuba_msgs, srv, ArmCommand_Response)() {
...
// already included above
// #include "skuba_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "skuba_msgs/srv/arm_command.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, skuba_msgs, srv, ArmCommand)() {
