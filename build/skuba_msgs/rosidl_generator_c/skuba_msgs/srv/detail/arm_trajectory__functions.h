...
#ifndef SKUBA_MSGS__SRV__DETAIL__ARM_TRAJECTORY__FUNCTIONS_H_
#define SKUBA_MSGS__SRV__DETAIL__ARM_TRAJECTORY__FUNCTIONS_H_
...
/// Initialize srv/ArmTrajectory message.
/**
...
/// Finalize srv/ArmTrajectory message.
/**
...
/// Create srv/ArmTrajectory message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * skuba_msgs__srv__ArmTrajectory_Request__init().
...
/// Destroy srv/ArmTrajectory message.
/**
 * It calls
 * skuba_msgs__srv__ArmTrajectory_Request__fini()
...
/// Check for srv/ArmTrajectory message equality.
/**
...
/// Copy a srv/ArmTrajectory message.
/**
...
/// Initialize array of srv/ArmTrajectory messages.
/**
...
/// Finalize array of srv/ArmTrajectory messages.
/**
 * It calls
 * skuba_msgs__srv__ArmTrajectory_Request__fini()
...
/// Create array of srv/ArmTrajectory messages.
/**
 * It allocates the memory for the array and calls
 * skuba_msgs__srv__ArmTrajectory_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/ArmTrajectory messages.
/**
 * It calls
 * skuba_msgs__srv__ArmTrajectory_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/ArmTrajectory message array equality.
/**
...
/// Copy an array of srv/ArmTrajectory messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * skuba_msgs__srv__ArmTrajectory_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_skuba_msgs
...
/**
 * It calls
 * skuba_msgs__srv__ArmTrajectory_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_skuba_msgs
...
/**
 * It allocates the memory for the array and calls
 * skuba_msgs__srv__ArmTrajectory_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_skuba_msgs
...
/**
 * It calls
 * skuba_msgs__srv__ArmTrajectory_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // SKUBA_MSGS__SRV__DETAIL__ARM_TRAJECTORY__FUNCTIONS_H_
